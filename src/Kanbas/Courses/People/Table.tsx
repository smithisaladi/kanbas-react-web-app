      ...
      <table className="table table-striped">
        ...
        <tbody>
          <tr><td className="wd-full-name text-nowrap">
            ...
            <td className="wd-login-id">001234771S</td>
            ...
            <td className="wd-login-id">001664561S</td>
            <td className="wd-section">S108</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-11-01</td>
            <td className="wd-total-activity">10:21:52</td> </tr>

            <tr><td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Bruce</span>{" "}
              <span className="wd-last-name">Wayne</span></td>
            <td className="wd-login-id">001222561S</td>
            <td className="wd-section">S701</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2022-12-01</td>
            <td className="wd-total-activity">16:21:32</td> </tr>
